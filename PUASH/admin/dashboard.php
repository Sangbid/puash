...
$result1 = mysqli_query($con,"select count(1) FROM contact");
$row = mysqli_fetch_array($result1);
$total5= $row[0];
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="panel panel-white no-radius text-center">
                                <a href="admin-contact.php">
                                    <div class="panel-body">
                                        <div class="statistic-box">
                                            <h2><span class="count-number"><?php echo $total5 ?></span></h2>
												<a class="btn-01" href="admin-contact.php">
													<i class="fa fa-files-o"></i>
												</a>
												<a href="admin-contact.php"><h3 class="naame"> User Helpline </h3></a>
                                            <div class="sparkline1 text-center"></div>
                                        </div>
                                    </div>
                                </a>    
